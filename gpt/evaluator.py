...
def simple_evaluate(
    ...
    elif "Mistral" in model_args:
        from lm_eval.modify_model import modify_mistral
        lm = modify_mistral(lm, args)
    elif "neox" in model_args or "pythia" in model_args:
        from lm_eval.modify_model import modify_neox
        lm = modify_neox(lm, args)
    else:
