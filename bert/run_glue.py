...
class ModelArguments:
    ...
    repeat_time_or_seed: int = field(default=None)
...
def main():
    ...
    # === Painter ===
    model.bert.encoder.method = model_args.method
    model.bert.encoder.start_layer = model_args.start_layer
    model.bert.encoder.repeat_time_or_seed = model_args.repeat_time_or_seed
    # ===============
